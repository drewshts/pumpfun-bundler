...
class GlobalAccount {
    ...
    getInitialBuyPrice(amount) {
        ...
        const tokenAmount = s < this.initialRealTokenReserves ? s : this.initialRealTokenReserves;

        this.initialVirtualTokenReserves = this.initialVirtualTokenReserves - tokenAmount;
        this.initialVirtualSolReserves = this.initialVirtualSolReserves + amount;
